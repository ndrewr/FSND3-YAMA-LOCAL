...
courses = []
courses.push(CourseItem(name="Udacity: JavaScript Basics",
...
courses.push(CourseItem(name="Udacity: JavaScript Design Patterns",
...
courses.push(CourseItem(name="Codeacademy: JavaScript Track",
...
courses.push(CourseItem(name="Udacity: Programming Foundations with Python",
...
courses.push(CourseItem(name="Codeacademy: Python Track",
...
courses.push(CourseItem(name="Codeacademy: Ruby on Rails Track",
...
courses.push(CourseItem(name="Treehouse: Learn Rails Development",
